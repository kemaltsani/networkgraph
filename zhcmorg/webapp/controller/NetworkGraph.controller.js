    sap.ui.define(
        ...
        function (JSONModel, Controller, LayeredLayout, ForceBasedLayout, ActionButton, Node, Fragment) {
            ...
            var GraphController = Controller.extend("zhcmorg.controller.NetworkGraph");
...
//                this._oModel = new JSONModel(sap.ui.require.toUrl("model/graph.json"));
                ...
                var element = { path: "OrgSet", parameters: { expand: "OrgToNodes" }}

                this._oModel.read("/OrgSet", {
                    async: false,
                    urlParameters:
                    {
                        $expand: "OrgToNodes"
   ...
                });
            ...
            GraphController.prototype._openDetail = function (oNode, oButton) {
                ...
                if (!this._oQuickView) {
                    Fragment.load({
                        name: "networkgraph.view.TooltipFragment",
                        type: "XML"
